        ...
        <li className={'taskLi ${className}'} >
            ...
            <div className='taskLi__group'>
                <label className='task-checkbox__container' htmlFor={id}>
                    <input className='task-checkbox' type="checkbox" id={id} checked={isDone} onChange={({target}) => onTaskCompleteChange(id, target.checked)}/>
            ...
            <button className='taskLi__button' onClick={() => onDeleteOneClick(id)}>
                <svg className='taskLi__button__svg' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
